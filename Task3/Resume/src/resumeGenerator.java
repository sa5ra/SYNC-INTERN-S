...
public class resumeGenerator {
    ...
    void createResume() throws IOException {
        ...
        try {
            ...
            resume.add(new Chunk("Qualifications ", font1));
            resume.add(Chunk.NEWLINE);
            PdfPTable table = new PdfPTable(3);
            PdfPCell cell1 = new PdfPCell(new Paragraph("School/College"));
            PdfPCell cell2 = new PdfPCell(new Paragraph("Percentage"));
            PdfPCell cell3 = new PdfPCell(new Paragraph("Passing Year"));
            PdfPCell cell4;
            ...
            resume.add(new Chunk("Graduation", font1));
            //resume.add(Chunk.NEWLINE);
            PdfPTable table1;
            ...
            PdfPCell cell13 = new PdfPCell(new Paragraph("Passing Year"));
            PdfPCell cell14;
